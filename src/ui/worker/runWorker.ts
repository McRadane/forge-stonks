...
import type { ILanguageContextDefinition, KeysLanguageType } from '@shared/resources/lang/type';
import type { IForgeCraft } from '@shared/resources/types';
import { setAttributes } from '@shared/services/attributes';
import type { IOptionsState } from '@shared/services/common';
import { setForgePrices, setTimerLaunched, setTimers } from '@shared/services/forge';
import { setGardenPrices } from '@shared/services/garden';
import { setOptions } from '@shared/services/options';
import { setPetPrices } from '@shared/services/pets';
import { setRNGPrices } from '@shared/services/rng';
import { setLoading, setNotLoading } from '@shared/services/worker';
import type {
...
import type { INotificationContextDefinition } from '@ui/notification/NotificationContext';
// eslint-disable-next-line sonarjs/no-implicit-dependencies
import Worker from '@worker/stonks.worker?worker';
