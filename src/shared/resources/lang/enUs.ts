...
export const enUsItems: ILanguage['items'] = {
  ...
  ENCHANTMENT_BLAST_PROTECTION_6: 'Blast Protection VI',
  ENCHANTMENT_BLAST_PROTECTION_7: 'Blast Protection VII',
  ENCHANTMENT_CHANCE_4: 'Looting IV',
  ENCHANTMENT_CHANCE_5: 'Looting V',
  ENCHANTMENT_CLEAVE_6: 'Cleave VI',
  ENCHANTMENT_CRITICAL_7: 'Critical VII',
  ENCHANTMENT_CUBISM_6: 'Cubism VI',
  ENCHANTMENT_ENDER_SLAYER_6: 'Ender Slayer VI',
  ENCHANTMENT_ENDER_SLAYER_7: 'Ender Slayer VII',
  ENCHANTMENT_EXECUTE_6: 'Execute VI',
  ENCHANTMENT_FIRE_PROTECTION_6: 'Fire Protection VI',
  ENCHANTMENT_FIRE_PROTECTION_7: 'Fire Protection VII',
  ENCHANTMENT_FIRST_STRIKE_5: 'First Strike V',
  ENCHANTMENT_GIANT_KILLER_6: 'Giant Killer VI',
  ENCHANTMENT_GIANT_KILLER_7: 'Giant Killer VII',
  ENCHANTMENT_GROWTH_6: 'Growth VI',
  ENCHANTMENT_GROWTH_7: 'Growth VII',
  ENCHANTMENT_LAPIDARY_1: 'Lapidary I',
  ENCHANTMENT_LIFE_STEAL_4: 'Life Steal IV',
  ENCHANTMENT_LIFE_STEAL_5: 'Life Steal V',
  ENCHANTMENT_LOOTING_5: 'Looting V',
  ENCHANTMENT_LUCK_7: 'Luck VII',
  ENCHANTMENT_POWER_6: 'Power VI',
  ENCHANTMENT_POWER_7: 'Power VII',
  ENCHANTMENT_PROJECTILE_PROTECTION_6: 'Projectile Protection VI',
  ENCHANTMENT_PROJECTILE_PROTECTION_7: 'Projectile Protection VII',
  ENCHANTMENT_PROSECUTE_6: 'Prosecute VI',
  ENCHANTMENT_PROTECTION_6: 'Protection VI',
  ENCHANTMENT_PROTECTION_7: 'Protection VII',
  ENCHANTMENT_RESPITE_3: 'Respite III',
  ENCHANTMENT_SCAVENGER_5: 'Scavenger V',
  ENCHANTMENT_SHARPNESS_6: 'Sharpness VI',
  ENCHANTMENT_SHARPNESS_7: 'Sharpness VII',
  ENCHANTMENT_SMITE_7: 'Smite VII',
  ENCHANTMENT_SNIPE_4: 'Snipe IV',
  ENCHANTMENT_SYPHON_4: 'Syphon IV',
  ENCHANTMENT_SYPHON_5: 'Syphon V',
  ENCHANTMENT_THUNDERBOLT_6: 'Thunderbolt VI',
  ENCHANTMENT_THUNDERBOLT_7: 'Thunderbolt VII',
  ENCHANTMENT_THUNDERLORD_7: 'Thunderlord VII',
  ENCHANTMENT_TITAN_KILLER_6: 'Titan Killer VI',
  ...
  'Experiment the Fish': 'Experiment the Fish',
  FERMENTO: 'Fermento',
  ...
  'Pickonimbus 2000': 'Pickonimbus 2000',
  PLASMA: 'Plasma',
...
export const enUs: ILanguage = {
  ...
  ui: {
    ...
    itemPricePerXP: 'Price / XP',
    items: 'Items',
    levels: 'Levels',
    materialList: 'Material list',
    neededXP: 'Needed XP',
    noCraftingCost: 'No crafting cost found for each steps',
    operation: 'Operation',
    options: {
    ...
    pageForge: 'Forge',
    pageGarden: 'Garden',
    pagePetsFlips: 'Pets Flips',
    pageRNGFlips: 'RNG Flips',
    price: 'Price',
    ...
    rngFlips: {
      ...
      experimentationTable: 'Experimentation Table'
    },
    sell: 'Sell',
